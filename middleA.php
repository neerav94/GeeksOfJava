...
<body>
    ...
    <div class="content container"></div>
         ...
         <h1 class="fnt" style="color: C52D2F"><center>Arrays</center></h1>
		 <div class="content container">
		<button id="e"><a href="middleA.php?level='E'&domain_id=1"> Easy </a></button>
		<button id="m"><a href="middleA.php?level='M'&domain_id=1"> Medium </a></button>
		<button id="d"><a href="middleA.php?level='H'&domain_id=1"> Hard </a></button>
	</div>
