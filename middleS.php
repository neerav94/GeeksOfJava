...
<body>
    ...
    <div class="content container"></div>
         ...
         <h1 class="fnt" style="color: C52D2F"><center>Stacks</center></h1>
		 <div class="content container">
		<button id="e"><a href="middleS.php?level='E'&domain_id=3"> Easy </a></button>
		<button id="m"><a href="middleS.php?level='M'&domain_id=3"> Medium </a></button>
		<button id="d"><a href="middleS.php?level='H'&domain_id=3"> Hard </a></button>
	</div>
